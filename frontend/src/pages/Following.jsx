  ...
  return (
    <div className="animate-fade-in">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-lg font-semibold">{profile?.username} is following</h1>
      </div>

      {following.length === 0 ? (
        <EmptyState title="Not following anyone" description="When this account follows people, they'll show up here." />
      ) : (
